...
<template>
 ...
 <div class="row">
  <router-link to="/store-speciality" class="btn btn-primary">Add Supplier  </router-link>
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="supplier in filtersearch" :key="supplier.id">
                        ...
                        <td> {{ supplier.speciality_name }} </td>
                        
                       
            <td>
   <router-link :to="{name: 'edit-speciality', params:{id:supplier.id}}" class="btn btn-sm btn-primary">Edit</router-link>
