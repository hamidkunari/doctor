...
<template>
 ...
 <div class="row">
  <router-link to="/speciality" class="btn btn-primary">All Speciality </router-link>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4"> Speciality Update</h1>
                  </div>
...
<script type="text/javascript">
  ...
  supplierUpdate(){
  	  let id = this.$route.params.id
       axios.patch('/api/speciality/'+id,this.form)
       .then(() => {
