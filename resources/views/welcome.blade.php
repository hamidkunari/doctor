...
<body id="page-top">
  ...
  <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true " style="display:  none;"> 
   ...
   <router-link class="collapse-item" to="/store-doctor">Add Doctor</router-link>
   <router-link class="collapse-item" to="/doctor">All Doctor</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/store-speciality">Add Speciality</router-link>
   <router-link class="collapse-item" to="/speciality">All Speciality</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/store-patient">Add Patient</router-link>
   <router-link class="collapse-item" to="/patient">All Patient</router-link>
...
<li class="nav-item">
   ...
   <router-link class="collapse-item" to="/transaction">All Transaction</router-link>
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
              <b><a href="#" target="_blank">Doctor Management</a></b>
            </span>
          </div>
        </div>
      </footer>
